...
const NAV_LINKS = [
    ...
    { href: '/author/books/upload', label: 'Upload Book' },
    { href: '/author/analytics', label: 'Analytics' },
    { href: '/author/notifications', label: 'Notifications' },
]
    ...
    return (
        <nav className="bg-white border-b border-gray-100 sticky top-0 z-30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
                {/* Logo */}
                <Link href="/author/dashboard" className="text-xl sm:text-2xl font-bold tracking-tighter flex-shrink-0">
